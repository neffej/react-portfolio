        ...
        <section id='about' className='about m-2'>
            ...
            <div className='row'>
                ...
                <div className='col-lg-8 pt-4 pt-lg-0 content aos-init aos-animate' data-aos="fade-left">
                    ...
                    <p className='fst-italic'>Experienced working with front and back-end development protocols, as well as Test-Driven Development and Progressive Web Applications</p>
                    <div className='row'>
                    ...
                    <p>
                        I'm looking for full-time remote work in full-stack, front-end or back-end development.  
                    </p>
                </div>
            ...
            <p>
                Skills are a pillar of utility. I began my interest in computer engineering with MS Excel, and have taken many steps with Georgia Tech's Full-Stack Flex Coding Boot Camp.  I'm actively pursuing projects to practice SQL & MongoDB, and I intend to learn Python and Tableau as well. Currently, I am familiar with:
            </p>
