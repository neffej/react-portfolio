...
import MyGif from '../../assets/GameTrack.gif'
        ...
        <section id="portfolio" className="portfolio-item">
            ...
            <div className="row project-container p-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" id="project-container">
                <div className="col-lg-4 portfolio-info">
                    <a href="https://github.com/neffej/game-track/" target="_blank" rel="noreferrer"><img className="img-fluid img-thumbnail" src={MyGif} alt="website gif"></img></a>
                </div>
