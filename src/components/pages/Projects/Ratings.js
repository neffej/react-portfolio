    ...
    return(
        <section id="portfolio" className="portfolio-item">
            ...
            <div className="row project-container p-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" id="project-container">
                ...
                <p>This deployed, online rating system was designed to allow community members to give anonymous feedback to police departments.  Users can search for their city and leave feedback anonymously, which is stored on the back-end.  There is also a login feature which allows users to see all of the feedback they have left.  Each city displays an average of their ratings, as well as a graphic that changes based on their score.     </p>
                <ul className="fs-4">Future Developments:
                    ...
                    <li className="fs-6">Allow registered users to post replies to feedback entries</li>
                </ul>
                <div>
